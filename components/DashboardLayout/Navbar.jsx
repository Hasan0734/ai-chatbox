...
const Navbar = ({setSidebarOpen, handleNewChatProp}) => {

    return (

        <div
            className="fixed backdrop-blur-sm top-0 z-40 left-0 md:left-[16rem] right-0
             bg-gray-900 flex flex-col md:flex-row items-center pb-2">

            <div className={'flex md:hidden items-center justify-between w-full shadow  px-4 sm:px-6 lg:px-8 '}>
                ...
                >
                    <button onClick={handleNewChatProp} className={cn(
            ...
            <div className={'flex items-center gap-x-4 sm:gap-x-6 w-full  px-4 sm:px-6 lg:px-8 py-2  mt-2'}>
